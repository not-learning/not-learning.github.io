...
/** @type {string} */
const CACHE_VERSION = '1750336719|6005107459';
/** @type {string} */
const CACHE_PREFIX = 'Einmaleins-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'einmaleins.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["einmaleins.html","einmaleins.js","einmaleins.offline.html","einmaleins.icon.png","einmaleins.apple-touch-icon.png","einmaleins.audio.worklet.js","einmaleins.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["einmaleins.wasm","einmaleins.pck"];
